...
# add annotations
plt.text(-40.5,58.5,'n=1',color = 'white')
plt.text(-40.5,125,'n=1',color = 'white')
plt.text(22,58.5,'n='+str(n_doublets),color = 'white')
plt.text(23.5,125,'n='+str(n_singlets),color = 'white')
