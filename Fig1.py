...
Tx_1to1d_average = np.nanmean(np.concatenate((AR1to1d_halfstim["TFM_data"]["Tx"][:,:,0:20,:],AR1to1d_fullstim_short["TFM_data"]["Tx"][:,:,0:20,:],AR1to1d_fullstim_long["TFM_data"]["Tx"][:,:,0:20,:]),axis=3),axis=(2,3))
Ty_1to1d_average = np.nanmean(np.concatenate((AR1to1d_halfstim["TFM_data"]["Ty"][:,:,0:20,:],AR1to1d_fullstim_short["TFM_data"]["Ty"][:,:,0:20,:],AR1to1d_fullstim_long["TFM_data"]["Ty"][:,:,0:20,:]),axis=3),axis=(2,3))
Tx_1to1s_average = np.nanmean(np.concatenate((AR1to1s_halfstim["TFM_data"]["Tx"][:,:,0:20,:],AR1to1s_fullstim_short["TFM_data"]["Tx"][:,:,0:20,:],AR1to1s_fullstim_long["TFM_data"]["Tx"][:,:,0:20,:]),axis=3),axis=(2,3))
Ty_1to1s_average = np.nanmean(np.concatenate((AR1to1s_halfstim["TFM_data"]["Ty"][:,:,0:20,:],AR1to1s_fullstim_short["TFM_data"]["Ty"][:,:,0:20,:],AR1to1s_fullstim_long["TFM_data"]["Ty"][:,:,0:20,:]),axis=3),axis=(2,3))

# get one example
Tx_1to1d_example = AR1to1d_halfstim["TFM_data"]["Tx"][:,:,0,0]
Ty_1to1d_example = AR1to1d_halfstim["TFM_data"]["Ty"][:,:,0,0]
Tx_1to1s_example = AR1to1s_halfstim["TFM_data"]["Tx"][:,:,0,0]
Ty_1to1s_example = AR1to1s_halfstim["TFM_data"]["Ty"][:,:,0,0]
...
im = axes[0,0].imshow(T_1to1d_example_crop, cmap=plt.get_cmap("turbo"), interpolation="bilinear", extent=extent, vmin=0, vmax=pmax, aspect='auto')
axes[0,0].quiver(xq[::n,::n], yq[::n,::n], Tx_1to1d_example_crop[::n,::n],Ty_1to1d_example_crop[::n,::n],angles='xy',scale = 10, units='width', color="r")
# axes[0,0].set_title('n=1', pad=-400, color='r')

axes[0,1].imshow(T_1to1d_average_crop, cmap=plt.get_cmap("turbo"), interpolation="bilinear", extent=extent, vmin=0, vmax=pmax, aspect='auto')
axes[0,1].quiver(xq[::n,::n], yq[::n,::n], Tx_1to1d_average_crop[::n,::n],Ty_1to1d_average_crop[::n,::n],angles='xy',scale = 10, units='width', color="r")

axes[1,0].imshow(T_1to1s_example_crop, cmap=plt.get_cmap("turbo"), interpolation="bilinear", extent=extent, vmin=0, vmax=pmax, aspect='auto')
axes[1,0].quiver(xq[::n,::n], yq[::n,::n], Tx_1to1s_example_crop[::n,::n],Ty_1to1s_example_crop[::n,::n],angles='xy',scale = 10, units='width', color="r")

axes[1,1].imshow(T_1to1s_average_crop, cmap=plt.get_cmap("turbo"), interpolation="bilinear", extent=extent, vmin=0, vmax=pmax, aspect='auto')
axes[1,1].quiver(xq[::n,::n], yq[::n,::n], Tx_1to1s_average_crop[::n,::n],Ty_1to1s_average_crop[::n,::n],angles='xy',scale = 10, units='width', color="r")
...
# add title
plt.suptitle('TFM',y=0.94, x=0.44)

# save figure
fig.savefig(folder+'figC.png', dpi=300, bbox_inches="tight")
...
# save plot to file
plt.savefig(folder+'figD.png', dpi=300, bbox_inches="tight")
...
# save figure
fig.savefig(folder+'figE.png', dpi=300, bbox_inches="tight")
...
# save figure
fig.savefig(folder+'figF.png', dpi=300, bbox_inches="tight")
...
# save plot to file
plt.savefig(folder+'figG.png', dpi=300, bbox_inches="tight")