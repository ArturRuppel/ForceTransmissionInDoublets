...
p = {'Ec':10*1e3,'Etac':100e3,'hc': 1e-6, 'vc': 0.5,'Es':20e3, 'hs': 50e-6, 'vs': 0.5,'Ya':1e9,'AIC':0.46,'Lc':50e-6,'s':s}
...
if __name__ == "__main__":
    ...
    sigma_x_data = ar1to2d['sigma_xx'][0:19]
    sigma_y_data = ar1to2d['sigma_yy'][0:19]
