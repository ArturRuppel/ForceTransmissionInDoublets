...
p = {'Ec':10*1e3,'Etac':100e3,'hc': 1e-6, 'vc': 0.5,'Es':20e3, 'hs': 50e-6, 'vs': 0.5,'Ya':1e9,'AIC':-0.61,'Lc':50e-6}
...
def f(x_init, *args):
    ...
    exp_data = ar2to1d['Es'][0:19]
    T_array = np.arange(0,60)[0:19]
    sigma_x_left_data = ar2to1d['sigma_xx_left'][0:19]
    sigma_y_left_data = ar2to1d['sigma_yy_left'][0:19]
