...
def doublet_simulation(fb,sx_increase,sy_increase,ea_input,l_act_input):
    ...
    y_halfstim = np.loadtxt("contour_2to1.txt", skiprows=1)
...
with open('all_results/halfstim_2to1_simulation.dat',"wb") as f:
    pickle.dump(dict_allEA, f,protocol=pickle.HIGHEST_PROTOCOL)

with open('all_results/halfstim_2to1_simulation.pickle',"wb") as f:
    pickle.dump(dict_allEA, f,protocol=pickle.HIGHEST_PROTOCOL)
